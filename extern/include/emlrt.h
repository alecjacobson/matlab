 ...
 */
#define EMLRT_VERSION_R2018A 0x2018A
#define EMLRT_VERSION_INFO  EMLRT_VERSION_R2018A
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtCheckArrayChecksumR2014a(emlrtConstCTX aTLS,
                                                         const char* aName,
                                                         const uint32_T* aCtCsVal,
                                                         const mxArray* aRtMxArray,
                                                         const boolean_T aIsGlobalVar);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtMEXProfilingFunctionEntry(const char* fcnUniqKey, boolean_T isMexOutdated);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtProfilerUnregisterMEXFcn(const char * fcnUniqKey, boolean_T isMexOutdated);

/*
 * MATLAB INTERNAL USE ONLY :: MEX Profiling Register Function
 */
EXTERN_C LIBEMLRT_API void emlrtProfilerRegisterMEXFcn(const char * completeName, const char * aPath, const char * aFcnName, int32_T numLineNos, const int32_T * lineNos, boolean_T isMexOutdated);
