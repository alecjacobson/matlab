        ...
        class ArrayFactory {
          public:
            ...
            ArrayFactory() {
                ...
                static const CreateArrayFactoryFcnPtr fcn = detail::resolveFunction<CreateArrayFactoryFcnPtr>
                    (detail::FunctionType::CREATE_ARRAY_FACTORY);
                
                impl::ArrayFactoryImpl* impl = nullptr;
                detail::throwIfError(fcn(&impl));
                pImpl = std::shared_ptr<impl::ArrayFactoryImpl>(impl,
                                                                [](impl::ArrayFactoryImpl* ptr) {
                                                                    typedef void(*DestroyArrayFactoryFcnPtr)(impl::ArrayFactoryImpl*);
                                                                    static const DestroyArrayFactoryFcnPtr destroyFcn = detail::resolveFunction<DestroyArrayFactoryFcnPtr>
            ...
            TypedArray<T> createArray(ArrayDimensions dims) {
                typedef int(*CreateArrayWithDimsFcnPtr)(impl::ArrayFactoryImpl*, 
                                                        int,
                                                        size_t*, 
                                                        size_t,
                                                        impl::ArrayImpl**);
                static const CreateArrayWithDimsFcnPtr fcn = detail::resolveFunction<CreateArrayWithDimsFcnPtr>
            ...
            createArray(ArrayDimensions dims, const T* const begin, const T* const end) {
                typedef int(*CreateArrayWithDimsAndDataFcnPtr)(impl::ArrayFactoryImpl* impl, 
                                                               int arrayType,
                                                               size_t* dims, 
                                                               size_t numDims,
                                                               ...
                                                               size_t numEl,
                                                               impl::ArrayImpl**);
                static const CreateArrayWithDimsAndDataFcnPtr fcn = detail::resolveFunction<CreateArrayWithDimsAndDataFcnPtr>
            ...
            createScalar(const T val) {
                typedef int(*CreateScalarArrayFcnPtr)(impl::ArrayFactoryImpl* impl,
                                                      int arrayType,
                                                      const void* data,
                                                      impl::ArrayImpl**);
            ...
            TypedArray<MATLABString> createScalar(const String val) {
                typedef int(*CreateScalarStringFcnPtr)(impl::ArrayFactoryImpl* impl, 
                                                       ...
                                                       size_t strlen,
                                                       impl::ArrayImpl**);
                static const CreateScalarStringFcnPtr fcn = detail::resolveFunction<CreateScalarStringFcnPtr>
            ...
            TypedArray<MATLABString> createScalar(const MATLABString val) {
                ...
                if (val) {
                    ...
                    typedef int(*CreateScalarMissingStringFcnPtr)(impl::ArrayFactoryImpl* impl, 
                                                                  impl::ArrayImpl**);
                    static const CreateScalarMissingStringFcnPtr fcn2 = detail::resolveFunction<CreateScalarMissingStringFcnPtr>
            ...
            */
            ...
            CharArray createCharArray(String str) {
                typedef int(*CreateCharArrayFromChar16FcnPtr)(impl::ArrayFactoryImpl* impl, 
                                                              const char16_t* data,
                                                              size_t strlen,
                                                              impl::ArrayImpl**);
                static const CreateCharArrayFromChar16FcnPtr fcn = detail::resolveFunction<CreateCharArrayFromChar16FcnPtr>
            ...
            CharArray createCharArray(std::string str) {
                ...
                typedef int(*CreateCharArrayFromStringFcnPtr)(impl::ArrayFactoryImpl* impl, 
                                                              const char* data,
                                                              size_t strlen,
                                                              impl::ArrayImpl**);
                static const CreateCharArrayFromStringFcnPtr fcn = detail::resolveFunction<CreateCharArrayFromStringFcnPtr>
            ...
            StructArray createStructArray(ArrayDimensions dims, std::vector<std::string> fieldNames) {
                ...
                static const CreateNamesFcnPtr fcn3 = detail::resolveFunction<CreateNamesFcnPtr>
                    (detail::FunctionType::CREATE_NAMES);
                NameList field_names(fcn3(fieldNames.size()));
                for (const auto& field : fieldNames) {
                    typedef void(*AddNameFcnPtr)(detail::NameListImpl* impl,
                                                const char* name,
                                                size_t nameLen);
                ...
                impl::ArrayImpl* impl = nullptr;
                typedef int(*CreateStructArrayFcnPtr)(impl::ArrayFactoryImpl* impl,
                                                      size_t* dims,
                                                      size_t numDims,
                                                      detail::NameListImpl* names,
                                                      impl::ArrayImpl**);
                static const CreateStructArrayFcnPtr fcn2 = detail::resolveFunction<CreateStructArrayFcnPtr>
                    (detail::FunctionType::CREATE_STRUCT_ARRAY);
                detail::throwIfError(fcn2(pImpl.get(), &dims[0], dims.size(), field_names.getImpl(), &impl));
            ...
            EnumArray createEnumArray(ArrayDimensions dims, std::string className, std::vector<std::string> enums) {
                ...
                impl::ArrayImpl* impl = nullptr;
                typedef int(*CreateEnumArrayWithEnumsFcnPtr)(impl::ArrayFactoryImpl* impl,
                                                             size_t* dims,
                                                             size_t numDims,
                                                             const char* cls,
                                                             size_t clsSize,
                                                             detail::NameListImpl* names,
                                                             impl::ArrayImpl** retVal);
                static const CreateEnumArrayWithEnumsFcnPtr fcn2 = detail::resolveFunction<CreateEnumArrayWithEnumsFcnPtr>
                    (detail::FunctionType::CREATE_ENUM_ARRAY_WITH_ENUMS);
                detail::throwIfError(fcn2(pImpl.get(), &dims[0], dims.size(), className.c_str(), className.size(), enum_names.getImpl(), &impl));
            ...
            EnumArray createEnumArray(ArrayDimensions dims, std::string className) {
                typedef int(*CreateEnumArrayFcnPtr)(impl::ArrayFactoryImpl*,
                                                    size_t*,
                                                    size_t,
                                                    const char*,
                                                    size_t,
                                                    impl::ArrayImpl**);
                static const CreateEnumArrayFcnPtr fcn = detail::resolveFunction<CreateEnumArrayFcnPtr>
                    (detail::FunctionType::CREATE_ENUM_ARRAY);
                impl::ArrayImpl* impl = nullptr;
                detail::throwIfError(fcn(pImpl.get(), &dims[0], dims.size(), className.c_str(), className.size(), &impl));
                return detail::Access::createObj<EnumArray>(impl);
            }
            ...
            buffer_ptr_t<T> createBuffer(size_t numberOfElements) {
                ...
                typedef int(*CreateBufferFcnPtr)(impl::ArrayFactoryImpl* impl,
                                                 void** buffer,
                                                 void(**deleter)(void*),
                                                 int dataType,
                                                 size_t numElements);
                static const CreateBufferFcnPtr fcn = detail::resolveFunction<CreateBufferFcnPtr>
                    (detail::FunctionType::CREATE_BUFFER);
                detail::throwIfError(fcn(pImpl.get(), &buffer, &deleter, static_cast<int>(GetArrayType<T>::type), numberOfElements));
            ...
            TypedArray<T> createArrayFromBuffer(ArrayDimensions dims,
                ...
                impl::ArrayImpl* impl = nullptr;
                typedef int(*CreateArrayFromBufferFcnPtr)(impl::ArrayFactoryImpl* impl, 
                                                          int arrayType,
                                                          size_t* dims, 
                                                          size_t numDims,
                                                          void* buffer,
             ...
             * @param cols - buffer containing the column value for each element. Buffer will not be copied. Array takes ownership
             *
            ...
            createSparseArray(ArrayDimensions dims, 
                ...
                impl::ArrayImpl* impl = nullptr;
                typedef int(*CreateSparseArrayFromBufferFcnPtr)(impl::ArrayFactoryImpl* impl, 
                                                                int arrayType,
                                                                size_t* dims, 
                                                                size_t numDims,
                                                                size_t nnz,
                                                                ...
                                                                impl::ArrayImpl**);
                static const CreateSparseArrayFromBufferFcnPtr fcn = detail::resolveFunction<CreateSparseArrayFromBufferFcnPtr>
                ...
                NameList(detail::NameListImpl* impl) :
                    pImpl(std::shared_ptr<detail::NameListImpl>
                        (impl, [](detail::NameListImpl* ptr) {
                            ...
                            static const DestroyNamesFcnPtr destroyFcn = detail::resolveFunction<DestroyNamesFcnPtr>
