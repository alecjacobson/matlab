...
namespace matlab {
    ...
    namespace data {
        ...
        using CantIndexIntoEmptyArrayException = detail::ArrayException<matlab::Exception, ExceptionType::CantIndexIntoEmptyArray>;
        using FeatureNotSupportedException = detail::ArrayException<matlab::Exception, ExceptionType::FeatureNotSupported>;
    } 
}
