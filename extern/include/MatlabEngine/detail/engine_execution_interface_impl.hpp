...
namespace matlab {
    namespace execution {
        ...
        const std::shared_ptr<StreamBuffer> &error
            ...
            uintptr_t handle = engine_feval_with_completion(matlabHandle, utf8functionname.c_str(), nlhs, false, argsImpl, nrhs, &set_feval_promise_data, &set_feval_promise_exception, p, output_, error_, &writeToStreamBuffer, &deleteStreamBufferImpl);
        ...
        const std::shared_ptr<StreamBuffer> &error
            ...
            std::string utf8functionname = convertUTF16StringToASCIIString(function); 
            uintptr_t handle = engine_feval_with_completion(matlabHandle, utf8functionname.c_str(), 1, true, argsImpl, nrhs, &set_feval_promise_data, &set_feval_promise_exception, p, output_, error_, &writeToStreamBuffer, &deleteStreamBufferImpl);
